...
//   const studyProgramExists = await StudyProgram.exists({ _id: data.studyProgramId });
...
//     .populate([{ path: 'studyProgram', select: { name: 1, length: 1, degree: 1 } }])
...
//     if (data.studyProgramId !== checkUser.studyProgramId) {
//       await StudyProgram.findOneAndUpdate(
//         { _id: checkUser.studyProgramId },
//         {
